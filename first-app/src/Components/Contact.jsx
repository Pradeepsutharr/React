                        ...
                        <form action="" className='py-16'>
                            ...
                            <div className="flex my-2">
                                <div className="w-full">
                                    ...
                                    <input id='email' className='border border-gray-300 rounded-md p-3 w-full' type="text" />
                                </div>
                            </div>
                            ...
                            <div className="flex">
                                <div className="w-full">
                                    ...
                                    <textarea rows={6} className='w-full border rounded-md border-gray-300' name="" id=""></textarea>
                                </div>
                            </div>

                            <div className="submit mt-10">
                                <input className='cursor-pointer bg-gray-800 px-5 py-3 text-white rounded-full' type="submit" value="Send Message" />
                            </div>
                        </form>

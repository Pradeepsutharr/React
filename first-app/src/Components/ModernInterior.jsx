            ...
            <div classname="content">
              ...
              <ul className=" ps-4 list-disc flex flex-wrap gap-y-4 justify-between">
                <li className="w-5/12 text-green-900">
                  <p className="text-gray-500 font-normal text-sm">Donec vitae odio quis nisl dapibus malesuada</p>
                </li>
                <li className="w-5/12 text-green-900">
                  <p className="text-gray-500 font-normal text-sm">Donec vitae odio quis nisl dapibus malesuada</p>
                </li>
              ...
              <button className="px-6 py-3 rounded-full font-medium bg-gray-800 text-white mt-6 hover:bg-gray-900 duration-300">Explore</button>
            </div>
          </div>
        </div>
      </div>
